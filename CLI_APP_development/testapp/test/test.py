...
class MysqlDatabase:
    ...
    def remove_data(self, table, taskids):
        for taskid in taskids:
            mycursor.execute(f"delete FROM {table} WHERE taskid = {taskid}")
        mydb.commit()
'''
...
if __name__ == "__main__":
    ...
    my_parser.add_argument('--list', type = str , const= "All", nargs= "?", choices= ['Incomplete', 'Complete'])
    my_parser.add_argument('--create', type = str,  nargs= "+")
    my_parser.add_argument('--edit-title', nargs=2)
    my_parser.add_argument('--edit-status', nargs = 2)
    my_parser.add_argument('--delete', nargs = "+")
    ...
    if args.list:
        ...
        d1.update_title("task", args.edit_title[0],args.edit_title[1])
    elif args.edit_status:
        d1.update_status("task", args.edit_status[0], args.edit_status[1])
    elif args.delete:
        d1.remove_data("task", args.delete)